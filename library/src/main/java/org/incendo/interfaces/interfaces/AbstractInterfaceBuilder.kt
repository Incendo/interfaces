...
public abstract class AbstractInterfaceBuilder<P : Pane, I : Interface<P>> internal constructor() :
    ...
    protected val clickPreprocessors: MutableCollection<org.incendo.interfaces.click.ClickHandler> = mutableListOf()
    ...
    public fun withPreprocessor(handler: org.incendo.interfaces.click.ClickHandler) {
